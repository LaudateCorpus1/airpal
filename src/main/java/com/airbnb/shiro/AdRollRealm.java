...
@Slf4j
public class AdRollRealm extends JndiLdapRealm
{
    @Setter
    private List<UserGroup> groups = Collections.emptyList();
    private JndiLdapContextFactory lcf;
    private static String REALM_NAME = AdRollRealm.class.getSimpleName();
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException
    {
        ...
        AllowAllUser user = new AllowAllUser(usernamePasswordToken.getUsername(),
                                                ImmutableSet.of("all"),
                                                "default",
        ...
        return new SimpleAuthenticationInfo(user,
                ...
                AdRollRealm.class.getSimpleName());
    }
